...
class DepthModel:
    ...
    def _get_encoder(self):
        ...
        raise ValueError(
            "Invalid encoder specified. Please specify either vits, vitb, or vitl."
        )
    ...
    def _load_model(self):
        ...
        model_path = (
            self.model_load_dir / f"depth_anything_{self.version}_{self.encoder}.pth"
        )
